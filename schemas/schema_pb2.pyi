...
class Backup(_message.Message):
    __slots__ = ("backupManga", "backupCategories", "backupSources", "backupPreferences", "backupSourcePreferences", "backupExtensionStores")
    ...
    BACKUPEXTENSIONSTORES_FIELD_NUMBER: _ClassVar[int]
    ...
    backupExtensionStores: _containers.RepeatedCompositeFieldContainer[BackupExtensionStore]
    def __init__(self, backupManga: _Optional[_Iterable[_Union[BackupManga, _Mapping]]] = ..., backupCategories: _Optional[_Iterable[_Union[BackupCategory, _Mapping]]] = ..., backupSources: _Optional[_Iterable[_Union[BackupSource, _Mapping]]] = ..., backupPreferences: _Optional[_Iterable[_Union[BackupPreference, _Mapping]]] = ..., backupSourcePreferences: _Optional[_Iterable[_Union[BackupSourcePreferences, _Mapping]]] = ..., backupExtensionStores: _Optional[_Iterable[_Union[BackupExtensionStore, _Mapping]]] = ...) -> None: ...
...
class BackupChapter(_message.Message):
    __slots__ = ("url", "name", "scanlator", "read", "bookmark", "lastPageRead", "dateFetch", "dateUpload", "chapterNumber", "sourceOrder", "lastModifiedAt", "version", "memo")
    ...
    lastModifiedAt: int
    version: int
    memo: _containers.RepeatedScalarFieldContainer[bytes]
    def __init__(self, url: _Optional[str] = ..., name: _Optional[str] = ..., scanlator: _Optional[str] = ..., read: bool = ..., bookmark: bool = ..., lastPageRead: _Optional[int] = ..., dateFetch: _Optional[int] = ..., dateUpload: _Optional[int] = ..., chapterNumber: _Optional[float] = ..., sourceOrder: _Optional[int] = ..., lastModifiedAt: _Optional[int] = ..., version: _Optional[int] = ..., memo: _Optional[_Iterable[bytes]] = ...) -> None: ...

class BackupExtensionStore(_message.Message):
    __slots__ = ("indexUrl", "name", "badgeLabel", "signingKey", "contactWebsite", "contactDiscord", "isLegacy", "extensionListUrl")
    INDEXURL_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    BADGELABEL_FIELD_NUMBER: _ClassVar[int]
    SIGNINGKEY_FIELD_NUMBER: _ClassVar[int]
    CONTACTWEBSITE_FIELD_NUMBER: _ClassVar[int]
    CONTACTDISCORD_FIELD_NUMBER: _ClassVar[int]
    ISLEGACY_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, indexUrl: _Optional[str] = ..., name: _Optional[str] = ..., badgeLabel: _Optional[str] = ..., signingKey: _Optional[str] = ..., contactWebsite: _Optional[str] = ..., contactDiscord: _Optional[str] = ..., isLegacy: bool = ..., extensionListUrl: _Optional[str] = ...) -> None: ...
...
class BackupManga(_message.Message):
    __slots__ = ("source", "url", "title", "artist", "author", "description", "genre", "status", "thumbnailUrl", "dateAdded", "viewer", "chapters", "categories", "tracking", "favorite", "chapterFlags", "viewer_flags", "history", "updateStrategy", "lastModifiedAt", "favoriteModifiedAt", "excludedScanlators", "version", "notes", "initialized", "memo")
